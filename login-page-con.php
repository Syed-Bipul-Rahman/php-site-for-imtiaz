...
<section class="px-0 xs:px-2 sm:px-6 lg:px-20 py-20 flex justify-center">
    <div style="box-shadow: 3px 2px 19px #7e7979;" class="xs:p-4 sm:p-6 md:p-8 lg:p-12 lg:w-2/5 rounded-xl">
        ...
        <P><?php if (isset($_SESSION["errorlogin"])) {
                ...
                echo '<p style="color: red" class="text-center text-red-500 font-semibold">' . $_SESSION['errorlogin'] . '</p>';
           unset($_SESSION["errorlogin"]);
           
           } ?></P>
        <form action="" method="post">
            <input class="w-full border border-slate-400 h-12 p-2 my-2 rounded-md" type="email" name="uname" id="" placeholder="Email Address">
            <input class="w-full border border-slate-400 h-12 p-2 mt-2 rounded-md" type="password" name="pass" id="" placeholder="Password">
            ...
            <input type="submit" name="sub" value="Sign in" class="w-full cursor-pointer py-2 bg-orange-500 text-white rounded-md font-bold text-center text-lg uppercase" />
        ...
        <p class="text-center text-lg font-medium mt-6">Don't have an account?<a class="mx-2 text-orange-500 hover:text-blue-800 transition-all " href="./register.php">Register
                Now</a></p>
    </div>
