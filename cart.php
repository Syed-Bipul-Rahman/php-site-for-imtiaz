...
<section class="px-0 xs:px-2 sm:px-6 lg:px-20 py-20 lg:flex lg:justify-between">
    <div class="lg:w-2/3 flex flex-col">
        <table>
            ...
            <tbody>
                ...
                <tr class="h-20 border-b border-slate-400 text-center text-lg">
                    ...
                    <td class="flex justify-center my-2"><img loading="lazy" class="h-16 m-0"
                            src="<?php echo $row['img'] ?>" alt="<?php echo $row['title'] ?>">
                    </td>
        ...
        <div class="flex my-4">
            <input class="mx-4 p-2  border border-slate-400 rounded-sm font-medium" type="text" name="" id=""
    ...
    <div class="lg:w-[30%] w-full">
        ...
        <?php
                        ...
                        $conn->close();
                        ?>
        <a href="./possiblecheckout.php"><button
                class="py-4 px-6 bg-orange-500 text-white hover:bg-blue-900 font-bold rounded-md w-full my-2">PROCEED TO
                CHECKOUT</button></a>
    </div>
</section>
...
<?php
                        ...
                        echo "<h1 class='text-center text-2xl font-bold py-20'>No Course in cart</h1>";
                    }
